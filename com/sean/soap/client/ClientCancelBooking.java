...
public class ClientCancelBooking extends JFrame {
	...
	public ClientCancelBooking(BookingInterface newBookingInterface) {
	...
	private void initialiseUI() {
		...
		validateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				// Cancel a specified room
				roomStatus = bookingInterface.cancelBooking(submitRoomName, dayValue, timeValue);
    ...
    private JPanel createCenterPanel() {
        ...
        centerPanel.setBorder(BorderFactory.createTitledBorder("Cancel Booking"));
